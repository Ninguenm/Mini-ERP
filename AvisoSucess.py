...
class AvisoApp:
    def __init__(self, master=None):
        ...
        self.label2.configure(font='{arial} 16 {}', foreground='#009700', justify='left', relief='groove')
        self.label2.configure(takefocus=True, text='Sucesso!')
