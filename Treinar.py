...
import pygubu
import CadastrarTreinados,CadastrarTreinadosDes
...
class TreinarApp:
    def __init__(self, master=None):
        ...
        self.label2.configure(text='Cadastrar Treinamento')
        ...
        self.button1.configure(command=CadastrarTreinados.abre)
        ...
        self.button3.configure(command=CadastrarTreinadosDes.abre)
