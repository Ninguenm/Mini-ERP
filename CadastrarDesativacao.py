...
class DesativacaoApp:
    def __init__(self, master=None):
        # build ui
        self.toplevel1 = tk.Tk() if master is None else tk.Toplevel(master)
        self.toplevel1.title("Desativação de Equipamento")
        self.frame2 = tk.Frame(self.toplevel1)
        self.label2 = tk.Label(self.frame2)
        self.label2.configure(font='{arial} 16 {}', justify='left', relief='groove', takefocus=False)
        self.label2.configure(text='Desativação de Equipamento')
        self.label2.place(anchor='nw', relx='0.125', rely='0.04', width='330', x='0', y='0')
        self.entPatri = tk.Entry(self.frame2)
        self.entPatri.configure(justify='left')
        self.entPatri.place(anchor='nw', relx='0.33', rely='0.14', width='170', x='0', y='0')
        self.entNumSerie = tk.Entry(self.frame2)
        self.entNumSerie.place(anchor='nw', relx='0.33', rely='0.24', width='170', x='0', y='0')
        self.entData_Desativ = tk.Entry(self.frame2)
        self.entData_Desativ.place(anchor='nw', relx='0.33', rely='0.34', width='170', x='0', y='0')
        self.entMotivo_Desativ = tk.Entry(self.frame2)
        self.entMotivo_Desativ.place(anchor='nw', relx='0.33', rely='0.44', width='170', x='0', y='0')
        self.entNum_Processo = tk.Entry(self.frame2)
        self.entNum_Processo.place(anchor='nw', relx='0.33', rely='0.54', width='170', x='0', y='0')
        self.entObs = tk.Entry(self.frame2)
        self.entObs.place(anchor='nw', relx='0.33', rely='0.64', width='170', x='0', y='0')
        
        self.lblPatri = tk.Label(self.frame2)
        self.lblPatri.configure(relief='groove', takefocus=False, text='*Patrimônio')
        self.lblPatri.place(anchor='nw', relx='0.030', rely='0.14', width='130', x='0', y='0')
        self.lblNumSerie = tk.Label(self.frame2)
        self.lblNumSerie.configure(relief='groove', text='*Número de Série')
        self.lblNumSerie.place(anchor='nw', relx='0.03', rely='0.24', width='130', x='0', y='0')
        self.lblData_Desativ = tk.Label(self.frame2)
        self.lblData_Desativ.configure(relief='groove', text='*Data de Desativação')
        self.lblData_Desativ.place(anchor='nw', relx='0.03', rely='0.34', width='130', x='0', y='0')
        self.lblMotivo_Desativ = tk.Label(self.frame2)
        self.lblMotivo_Desativ.configure(relief='groove', text='*Motivo de Desativação')
        self.lblMotivo_Desativ.place(anchor='nw', relx='0.03', rely='0.44', width='130', x='0', y='0')
        self.lblNum_Processo = tk.Label(self.frame2)
        self.lblNum_Processo.configure(relief='groove', text='*Número de Processo')
        self.lblNum_Processo.place(anchor='nw', relx='0.03', rely='0.54', width='130', x='0', y='0')
        self.lblObs = tk.Label(self.frame2)
        self.lblObs.configure(relief='groove', text='Observação')
        self.lblObs.place(anchor='nw', relx='0.03', rely='0.64', width='130', x='0', y='0')
        self.lblCarta = tk.Label(self.frame2)
        self.lblCarta.configure(relief='groove', text='Carta Descontinuidade')
        self.lblCarta.place(anchor='nw', relx='0.03', rely='0.74', width='130', x='0', y='0')
        ...
        self.btnAnexar.place(anchor='nw', relx='0.33', rely='0.74', width='170',height='20', x='0', y='0')
        self.btnAnexar.configure(command=self.inserirArquivo)
        self.entCaminho = tk.Entry(self.frame2)
        self.entCaminho.place(anchor='nw', relx='0.03', rely='0.78', width='302', x='0', y='0')
...
""")
        ...
        self.label1.place(anchor='nw', relx='0.07', rely='0.835', x='0', y='0')
    ...
    def insert(self):
        try:
            Programa.cadastrarDesativacao(self.entPatri.get(),self.entNumSerie.get(),self.entData_Desativ.get(),self.entMotivo_Desativ.get(),self.entNum_Processo.get(),self.entObs.get(),self.entCaminho.get())
            self.mainwindow.destroy()
            AvisoSucess.abre()
        except TypeError:
